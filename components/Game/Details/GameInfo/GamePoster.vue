...
<template>
  <div
    class="sticky top-[calc(5rem+0.25rem)] flex flex-col gap-4 rounded-xl bg-neutral p-4 outline outline-secondary @md:mx-auto @md:grid @md:max-w-xl @md:grid-cols-2 @md:items-center"
  >
    <figure class="">
